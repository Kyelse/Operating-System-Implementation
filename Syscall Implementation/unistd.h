...
//* kernel/sys.c */
#define __NR_csc452_send_msg 443
__SYSCALL(__NR_csc452_send_msg, sys_csc452_send_msg)
#define __NR_csc452_get_msg 444
__SYSCALL(__NR_csc452_get_msg, sys_csc452_get_msg)
#undef __NR_syscalls
